...
import { AfterContentInit, AfterViewChecked, AfterViewInit, Component, ContentChildren, Directive, ElementRef, EventEmitter, HostListener, Injectable, Input, NgModule, NgZone, OnDestroy, OnInit, Output, QueryList, TemplateRef, ViewChild } from '@angular/core';
import { DomHandler, FilterMetadata, SortMeta } from 'primeng/api';
import { ObjectUtils } from 'primeng/components/utils/objectutils';
import { PaginatorModule } from 'primeng/paginator';
import { Column, PrimeTemplate, SharedModule } from 'primeng/shared';
