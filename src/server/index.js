...
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, server_1.router);
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, documents_1.router);
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, user_settings_1.router);
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, suggest_1.router);
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, utils_1.router);
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, registers_1.router);
app.use(`${environment_1.SUBSCRIPTION_ID}/api`, check_auth_1.default, tasks_2.router);
